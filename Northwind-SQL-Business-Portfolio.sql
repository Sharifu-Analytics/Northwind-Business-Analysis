...
/* Using VIEW statement for permanent store sale_data */
...
/* Which customers generate the highest revenue and how many orders did they place
...
/* Which calendar month generated the highest value?*/
...
/* Show the monthly sales over time*/
...
/* To avoid extrra spaces before months use FMMONTH, FM means fill mode, removes extra space*/
...
/* Running Total Revevue with Window function OVER()*/
...
/* Ranking of the product by three functions, ROW_NUMBER(), RANK(), DENSE_RANK()*/
...
/* Find the highest revenue producing customers in each country*/
...
/* ADD employee field to the sales_data view to calculate employee performance*/
...
/* Verificatio of adding new colum emploee*/
...
/* Top performing employee in each year*/
...
/* Which product category generated highest revenue in each year?*/
...
/* How did each employee performed each year?*/
...
ORDER BY 
		sales_year,
		employee_rank;
/* Which are the top 3 revenue-generating products within each category?*/
...
/* Which employee generated the highest revenue from customers in each country?*/
